...
CORBA::Boolean WholeBodyMasterSlaveService_impl::changeWholeBodyMasterSlaveRotation()
{
    return m_wholebodymasterslave->changeWholeBodyMasterSlaveRotation();
};

CORBA::Boolean WholeBodyMasterSlaveService_impl::changeWholeBodyMasterSlaveTranslation()
{
    return m_wholebodymasterslave->changeWholeBodyMasterSlaveTranslation();
};
