...
// geometry
//  function 'sqr' is defined in both RobotHardware/defs.h and boost/geometry.hpp. boost/geometry.hpp have to be included before RobotHardware/defs.h, otherwise conflict errors will occur.
